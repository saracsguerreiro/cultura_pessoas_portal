...
export default function App() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden" style={{ fontFamily: "'Outfit', sans-serif" }}>
      ...
      {/* ══ LOGIN SCREEN ══ */}
      {!authed && (
        <div className="absolute inset-0 z-40 flex" style={{ fontFamily: "'Outfit', sans-serif" }}>
          ...
          <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-16 gap-0">
            <img src={juntosLogo} alt="Juntos Somos TIS" style={{ width: 468, filter: 'brightness(0) invert(1)', opacity: 1, padding: 0 }} />
            <div style={{ width: '36%', height: 1, background: 'rgba(255,255,255,0.28)', margin: '22px 0 20px' }} />
            <div className="text-center" style={{ border: 'none', paddingTop: 5, paddingBottom: 5 }}>
          ...
          <div className="relative z-10 self-stretch" style={{ width: 1, background: 'rgba(255,255,255,0.14)', margin: '48px 0' }} />

          {/* ── Right panel — compact login form ── */}
          <div className="relative z-10 flex flex-col items-center justify-center px-10" style={{ width: '42%' }}>
      ...
      {authed && (
        <>
          {/* ── Top Navigation ── */}
          <header className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-10 py-5">
            <img src={tisLogoSvg} alt="TIS" style={{ height: 33, width: 'auto', filter: 'brightness(0) invert(1)' }} />
          ...
          {/* ── Juntos Somos TIS — bottom-left ── */}
          <div className="absolute z-25 bottom-8 left-10 pointer-events-none" style={{ opacity: chatOpen || activeNav !== 'sobre' ? 0 : 0.82, transition: `opacity 0.38s ${ease}` }}>
            <img src={juntosLogo} alt="Juntos Somos TIS" style={{ width: 178, filter: 'brightness(0) invert(1)' }} />
          </div>

          {/* ── Content layer ── */}
          <div className="absolute inset-0 z-20" style={{ paddingTop: '72px' }}>

            {/* ══ INÍCIO (home) ══ */}
            {activeNav === 'sobre' && (
            <div className="relative h-full flex items-center overflow-hidden">

              {/* ── Speech bubbles — 5 slots, right side, scattered ── */}
              {bubbles.map(b => {
              ...
              <div className="absolute inset-0 flex flex-col justify-center text-white"
                style={{ paddingLeft: 'clamp(2.5rem, 8vw, 7rem)', paddingRight: 'clamp(2rem, 10vw, 18rem)', opacity: chatOpen ? 0 : 1, transform: chatOpen ? 'translateX(-24px)' : 'translateX(0)', transition: `opacity 0.38s ${ease}, transform 0.38s ${ease}`, pointerEvents: chatOpen ? 'none' : 'auto' }}
              >
                <p className="mb-2 text-xl font-light text-white/80" style={{ letterSpacing: '0.18em' }}>Portal da Direcção de</p>
                <h1 className="mb-6 font-extrabold leading-none text-white" style={{ fontSize: 'clamp(3rem, 5.5vw, 5.2rem)', letterSpacing: '0.02em' }}>
                  CULTURA{' '}<span className="font-light text-white/75">&amp;</span>{' '}PESSOAS
                </h1>
                <p className="mb-1 text-2xl font-light text-white/70" style={{ letterSpacing: '0.04em' }}>Informação. Respostas. Recursos.</p>
                <p className="mb-10 text-2xl font-bold" style={{ letterSpacing: '0.02em' }}>Tudo num só lugar.</p>
                <div className="relative inline-flex self-start">
                  ...
                  <button onClick={openChat} className="relative inline-flex items-center gap-4 rounded-full bg-white px-10 py-4 font-bold text-[#036ef2] hover:bg-white/95 active:scale-[0.98]" style={{ fontSize: '1.125rem', letterSpacing: '0.01em', animation: 'cta-glow 2s ease-in-out infinite', transition: 'transform 0.15s' }}>
              ...
              {/* ── Chat panel ── */}
              <div className="absolute inset-y-0 right-0 left-0 flex flex-col py-5 px-8"
              ...
              >
                <div className="flex-1 flex flex-col rounded-2xl overflow-hidden" style={chatGlass}>
                  ...
                  <div className="flex-1 flex min-h-0">
                    ...
                    {/* ── Left sidebar: agent + topics ── */}
                    <div className="w-64 shrink-0 flex flex-col" style={{ borderRight: '1px solid rgba(255,255,255,0.15)', background: 'rgba(255,255,255,0.07)' }}>
                    ...
                    <div className="flex flex-col shrink-0 overflow-hidden" style={{ width: historyOpen ? 220 : 0, transition: 'width 0.3s cubic-bezier(0.4,0,0.2,1)', borderLeft: historyOpen ? '1px solid rgba(255,255,255,0.12)' : 'none', background: 'rgba(0,0,0,0.20)' }}>
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="flex gap-6">
                        <div className="flex-1 flex flex-col gap-4">{col0.map((f, i) => renderFaq(f, i))}</div>
                        <div className="flex-1 flex flex-col gap-4">{col1.map((f, i) => renderFaq(f, i + half))}</div>
                      </div>
                    )
                  })()}
              ...
              return (
                <div className="h-full flex flex-col px-14 py-6 gap-4">
                  ...
                  <div className="flex-1 min-h-0 rounded-3xl p-4 relative overflow-hidden" style={{ background: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.18)', boxShadow: '0 8px 40px rgba(0,0,50,0.25)' }}>
                    ...
                    <div
                      className="absolute inset-0 rounded-3xl flex overflow-hidden"
                        ...
                        <>
                          ...
                          <div className="flex-1 flex flex-col overflow-hidden">
                            ...
                            <div className="flex-1 overflow-y-auto px-8 pb-8" style={{ scrollbarWidth: 'none' }}>
                              <h2 className="font-extrabold text-white leading-snug mb-5" style={{ fontSize: 'clamp(1.15rem,1.6vw,1.55rem)' }}>{selectedNews.title}</h2>
                              <p className="text-sm text-white/65 leading-relaxed mb-6 italic" style={{ borderLeft: '2px solid rgba(255,255,255,0.25)', paddingLeft: '1rem' }}>{selectedNews.excerpt}</p>
                              <div style={{ height: 1, background: 'rgba(255,255,255,0.10)', marginBottom: '1.5rem' }} />
                              {selectedNews.body?.split('\n\n').map((para, i) => (
                                <p key={i} className="text-sm text-white/60 leading-relaxed mb-4">{para}</p>
                              ))}
                            </div>
                          </div>
                        </>
            ...
            {activeNav === 'eventos' && (() => {
              ...
              return (
                <div className="relative h-full overflow-hidden">
                  <div className="relative z-10 h-full px-14 py-8 flex flex-col gap-5">

                    {/* Page header */}
                    <div className="flex items-center justify-between shrink-0">
                      <div>
                        <p className="text-xs font-bold text-white/40 uppercase mb-1" style={{ letterSpacing: '0.16em' }}>Portal</p>
                        <h2 className="text-4xl font-extrabold text-white">Eventos</h2>
                      </div>
                      <div className="flex justify-end" style={{ width: 280 }}>
                        <div className="flex items-center gap-3" style={{ background: 'rgba(255,255,255,0.10)', borderRadius: 14, padding: '6px 14px', border: '1px solid rgba(255,255,255,0.18)' }}>
                          ...
                          <span className="text-white font-semibold text-sm min-w-[140px] text-center">{PT_MONTHS[m]} {y}</span>
                          <button onClick={() => { setCalDate(new Date(y, m + 1, 1)); setSelectedDay(null); setSelectedEvent(null) }} className="text-white/60 hover:text-white text-lg px-1 transition-colors">›</button>
                        </div>
                      </div>
                    </div>

                    {/* 3-column body — no gap on container; margins applied per-item so list stays flush with right edge when detail is hidden */}
                    <div className="flex-1 flex min-h-0">

                      {/* ── Column 1: Calendar — fills available space ── */}
                      ...
                      {/* ── Column 2: Upcoming events list — always visible, fills remaining space ── */}
                      ...
                      {/* ── Column 3: Event detail — slides in, takes remaining space ── */}
                      <div
